...
<body>
  ...
  <!-- CONTACT HEADER -->
  <header class="text-center text-white py-5 bg-dark" style="background:url('https://picsum.photos/1200/400?contact') center/cover no-repeat;">
    <div class="container">
  ...
  <!-- CONTACT FORM -->
  <!-- The outer form tag was redundant and causing issues, removed it. -->
  <section class="py-5">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-7">
          <h2 class="mb-4 text-center">Send Us a Message</h2>
          <form id="contactForm"> <!-- Changed ID to be specific -->
            <div class="mb-3">
              <label for="name" class="form-label">Your Name</label>
              <input type="text" class="form-control" id="name" name="name" placeholder="Enter your name"> <!-- Added name="name" -->
            </div>
            <div class="mb-3">
              <label for="email" class="form-label">Email Address</label>
              <input type="email" class="form-control" id="email" name="email" placeholder="Enter your email"> <!-- Added name="email" -->
            </div>
            <div class="mb-3">
              <label for="message" class="form-label">Message</label>
              <textarea class="form-control" id="message" name="message" rows="5" placeholder="Type your message"></textarea> <!-- Added name="message" -->
            </div>
      ...
      <div class="row mt-5">
        <div class="col-lg-7 mx-auto text-center">
          ...
          <p class="mb-1"><strong>Email:</strong> support@shine.com</p>
          <p class="mb-1"><strong>Phone:</strong> (555) 123-4567</p>
          <p><strong>Address:</strong> 123 Shine Lane, Laguna, Philippines</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content text-center">
      <div class="modal-body py-5">
        <i class="fas fa-paper-plane fa-4x text-success mb-3"></i> <!-- Changed icon to reflect message sending -->
        <h4 class="mb-2" id="contactSuccessModalLabel">Message Sent!</h4>
        <p class="text-muted mb-4">Thank you for contacting us. We'll get back to you soon.</p>
